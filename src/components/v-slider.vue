  ...
  >
    <div class="justify-between flex flex-col mt-4">
      ...
      <router-link
        to="/materials"
        class="text-4xl pb-2 lg:text-9xl font-bold my-2 "
        >Материалы</router-link
      >

      <div class="link_btn w-full flex justify-center lg:justify-start mt-4">
        <router-link to="/catalog" class="text-2xl"
    ...
    <div class="slide_img">
      <div class="slide_item">
        <img class="hidden" src="../img/Rectangle1.webp" alt="" />
      </div>
      <!-- /.slide_item -->
    </div>
    <!-- /.slide_img -->
